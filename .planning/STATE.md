...
- [Phase 03.8]: Keep branded candidates Unsupported until exact service-role proof terminalizes them — Migration and fixture bytes cannot authorize production admission.
