...
| T-01-07 | Elevation | Password change on stolen session | medium | mitigate | `updateUser` sends `current_password` reauth attribute (`web/src/pages/Settings.tsx:14-20`) | closed |
